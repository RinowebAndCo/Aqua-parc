(function (factory) {
    ...
    'use strict';    var Slick = window.Slick || {};    Slick = (function () {
        ...
        if (_.options.wheel === true) {
            ...
            $(_.options.anchorSelector + ' [data-menuanchor]').on('click', function (e) {
                ...
                _.changeSlide({
                    data: {
                        message: 'index',                        index: parseInt($(this).data('menuanchor'))
                    }
                });
            });
        }
    ...
    };    Slick.prototype.setActiveAnchor = function (index) {
        var _ = this;
        if (_.options.anchor == true) {
            $(_.options.anchorSelector + ' [data-menuanchor]').removeClass('active');            if ($(_.options.anchorSelector + ' [data-menuanchor="' + index + '"]').length !== 0) {
